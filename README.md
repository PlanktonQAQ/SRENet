...
## Overview
SRENet (Saliency-Based Lighting Enhancement Network) is a deep learning framework designed for adaptive image lighting enhancement, with a focus on preserving and enhancing details in salient regions while optimizing overall visual quality.
